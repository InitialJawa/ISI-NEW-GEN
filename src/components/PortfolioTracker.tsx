  ...
  const updateConfigValue = (key: string, value: any) => {
    ...
    if (key === "activeConfig") {
      if (value === "prod") {
        ...
        nextConfig.growthWeight = 0.1;
        nextConfig.valueWeight = 0.3;
        nextConfig.momentumWeight = 0.35;
      } else if (value === "res") {
        nextConfig.qualityWeight = 0.25;
        nextConfig.growthWeight = 0.3;
        nextConfig.valueWeight = 0.1;
        nextConfig.momentumWeight = 0.35;
      }
    }
        ...
        <div className="md:col-span-1 xl:col-span-4 space-y-6 flex flex-col">
          <div className="bg-[#050505] rounded-2xl border border-white/[0.03] p-5 space-y-5">
              ...
              <div className="space-y-5 pt-2">
                ...
                >
                  <div className="flex justify-between items-center text-[10px]">
                    ...
                    <span className="font-mono font-bold text-white/80">
                      -{engineConfig.singleSellTrigger ?? 8}%
                    </span>
                  </div>
                  <input
                    type="range"
                ...
                >
                  <div className="flex justify-between items-center text-[10px]">
                    ...
                    <span className="font-mono font-bold text-white/80">
                      +{engineConfig.singleBuyTrigger ?? 5}%
                    </span>
                  </div>
                  <input
                    type="range"
              ...
              <div className="space-y-5 pt-2">
                ...
                >
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateConfigValue("topNCount", parseInt(e.target.value))
                    }
                    className="w-full h-1.5 bg-white/10 rounded-lg appearance-none cursor-pointer accent-white disabled:cursor-not-allowed"
                  />
                </div>
            ...
            >
              ...
              <div className="flex items-center bg-white/[0.02] border border-white/[0.05] p-1 rounded-xl">
                <button
                  type="button"
                  disabled={isSettingsLocked}
            ...
            >
              ...
              <div className="flex gap-2">
                ...
                >
                  ...
                  <option value="10" className="bg-[#050505]">
                    Low (Drop -10% in 5D)
                  </option>
                </select>
              </div>
            ...
            >
              <div className="flex justify-between items-center text-[10px]">
                ...
                <span className="font-mono font-bold text-white/90">
                  {engineConfig.reserveBufferPct ?? 10}% Target
                </span>
              </div>
              <input
                type="range"
                ...
                onChange={(e) =>
                  updateConfigValue("reserveBufferPct", Number(e.target.value))
                }
                className="w-full h-1.5 bg-white/10 rounded-lg appearance-none cursor-pointer accent-white disabled:cursor-not-allowed"
              />
            ...
            <div className="pt-4 border-t border-white/[0.05] flex justify-between items-center text-[10px] font-mono text-white/60">
              ...
              <button
                ...
                className="flex items-center gap-1.5 hover:text-white font-bold transition-colors cursor-pointer border border-white/5 bg-white/[0.02] px-3 py-1.5 rounded-lg text-white/60 uppercase tracking-widest"
                title="Reset Cash to Rp 100m"
              >
                <RotateCcw className="w-3 h-3" /> Reset Kas
              </button>
            </div>
          </div>
