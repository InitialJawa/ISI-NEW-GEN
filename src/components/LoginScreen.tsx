...
import { Hexagon, Activity, Mail, Lock } from 'lucide-react';
...
export function LoginScreen() {
  ...
  const handleSocialLogin = async (providerName: 'google' | 'github' | 'facebook') => {
    ...
    try {
      ...
      setError(err.message || `An error occurred with ${providerName} Sign-In.`);
    } finally {
      setLoading(false);
    }
  };
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="flex items-center">
            <input
              ...
              className="w-4 h-4 rounded-sm border-white/20 bg-black/50 text-emerald-500 focus:ring-emerald-500/50"
            />
